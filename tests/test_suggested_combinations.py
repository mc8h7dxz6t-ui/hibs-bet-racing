...
def test_build_engine_combinations_empty_when_few_picks(monkeypatch):
...
def test_build_engine_combinations_builds_double_trixie_lucky15(monkeypatch):
    frame = pd.DataFrame(
        [
            _pick_row(race_id="R1", horse_name="A", runner_id="r1", win_decimal=3.0),
            _pick_row(race_id="R2", horse_name="B", runner_id="r2", win_decimal=4.0),
            _pick_row(race_id="R3", horse_name="C", runner_id="r3", win_decimal=5.0),
            _pick_row(race_id="R4", horse_name="D", runner_id="r4", win_decimal=6.0),
            _pick_row(race_id="R5", horse_name="E", runner_id="r5", win_decimal=7.0),
        ]
    )
            ...
            "combinations": [
                {
                    ...
                    "bet_count": 1,
                    "legs": [
                        {"selection": "Horse A", "event": "York 14:00", "market": "each_way"},
                        {"selection": "Horse B", "event": "Ascot 15:00", "market": "each_way"},
                    ],
                }
            ],
            "singles": [],
