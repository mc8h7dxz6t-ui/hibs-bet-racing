...
**Purpose:** Gauge Inst++ capabilities against adjacent platforms using **factual, evidence-backed** criteria — not marketing scores or pricing.  
**Scope:** SKU / Inst++ infrastructure only.  
**Evidence source:** In-repo tests, `verify-bundle`, rigorous CI logs, and public product documentation for comparables.  
**Date:** July 2026

> **What we ship (no prices):** [PORTFOLIO_EVIDENCE_SHEET.md](PORTFOLIO_EVIDENCE_SHEET.md)
...
| Doc | Purpose |
|-----|---------|
| [PORTFOLIO_EVIDENCE_SHEET.md](PORTFOLIO_EVIDENCE_SHEET.md) | Factual 12-SKU evidence (no prices) |
| [INST_PLUS_GOLD_STANDARD.md](INST_PLUS_GOLD_STANDARD.md) | Nine dimensions bar |
| [PORTFOLIO_FULL_TECH_SALES_12.md](PORTFOLIO_FULL_TECH_SALES_12.md) | Full tech + sales index (includes pricing) |
