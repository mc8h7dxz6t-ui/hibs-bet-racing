...
> **LLM spend control plane:** Canonical sales demo is **`make demo-gold`** (11 steps, drift lockout in step 10). See [DEMO_GOLD.md](DEMO_GOLD.md) and [DEMO_GOLD.md](DEMO_GOLD.md). This buyer sheet covers the **#8 lifecycle CLI** SKU on `inst_spine`.
