...
> **License economics and valuation depth:** [PORTFOLIO_TECH_SALES_SHEET.md](PORTFOLIO_TECH_SALES_SHEET.md) · **One-page matrix:** [PORTFOLIO_SALES_SHEET.md](PORTFOLIO_SALES_SHEET.md)
