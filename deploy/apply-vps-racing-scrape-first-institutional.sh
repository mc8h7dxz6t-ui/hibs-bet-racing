...
HIBS_RACING_RESCUE_MAX=64
HIBS_RACING_TARGET_DQ_PCT=95
HIBS_RACING_THIN_RESCUE_DQ_PCT=90
HIBS_RACING_ENRICH_RECOVERY_MIN_PCT=95
HIBS_RACING_DQ_REBOOST_PASSES=2
HIBS_RACING_RP_LIVE_FETCH=auto
HIBS_RACING_THIN_RESCUE_RP_LIVE=auto
HIBS_RP_MAX_CONCURRENT_LIVE=1
HIBS_RP_TRIP_TTL_HOURS=1
